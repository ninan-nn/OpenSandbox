---
title: Contributing
description: Guide for contributing to the OpenSandbox project including development setup, coding standards, and pull request process.
---
...
OpenSandbox adheres to a [Code of Conduct](/community/code-of-conduct) that we expect all contributors to follow. Please read it before contributing to ensure a welcoming and inclusive environment for everyone.
...
3. **Discuss Major Changes**: For significant changes, open an issue first or submit an [OSEP](/community/oseps) to discuss your approach
4. **Review Architecture**: Read the [architecture overview](/architecture/) to understand the system design
...
See [server/DEVELOPMENT.md](https://github.com/opensandbox-group/OpenSandbox/blob/main/server/DEVELOPMENT.md) for detailed server development guide.
...
See [components/execd/DEVELOPMENT.md](https://github.com/opensandbox-group/OpenSandbox/blob/main/components/execd/DEVELOPMENT.md) for detailed execd development guide.
...
Please read the [OSEP overview](/community/oseps) to understand when an OSEP is required and how to submit one. Small bug fixes and minor improvements do not require an OSEP.
...
- [Server Development Guide](https://github.com/opensandbox-group/OpenSandbox/blob/main/server/DEVELOPMENT.md)
- [execd Development Guide](https://github.com/opensandbox-group/OpenSandbox/blob/main/components/execd/DEVELOPMENT.md)
- [OpenAPI Specifications](/api/)
- [Python SDK Documentation](/sdks/python)
- [Java/Kotlin SDK Documentation](/sdks/kotlin)
...
By contributing to OpenSandbox, you agree that your contributions will be licensed under the [Apache 2.0 License](https://github.com/opensandbox-group/OpenSandbox/blob/main/LICENSE).
