...
class TestCodeInterpreterE2E:
    ...
    async def test_02_java_code_execution(self):
        ...
        java_context = await code_interpreter.codes.create_context(SupportedLanguage.JAVA)
    ...
    async def test_03_python_code_execution(self):
        ...
        python_context = await code_interpreter.codes.create_context(SupportedLanguage.PYTHON)
    ...
    async def test_04_go_code_execution(self):
        ...
        go_context = await code_interpreter.codes.create_context(SupportedLanguage.GO)
    ...
    async def test_05_typescript_code_execution(self):
        ...
        ts_context = await code_interpreter.codes.create_context(SupportedLanguage.TYPESCRIPT)
    ...
    async def test_06_multi_language_support_and_context_isolation(self):
        ...
        python1 = await code_interpreter.codes.create_context(SupportedLanguage.PYTHON)
        python2 = await code_interpreter.codes.create_context(SupportedLanguage.PYTHON)
        java1 = await code_interpreter.codes.create_context(SupportedLanguage.JAVA)
        go1 = await code_interpreter.codes.create_context(SupportedLanguage.GO)
    ...
    async def test_07_concurrent_code_execution(self):
        ...
        python_c1 = await code_interpreter.codes.create_context(SupportedLanguage.PYTHON)
        java_c1 = await code_interpreter.codes.create_context(SupportedLanguage.JAVA)
        go_c1 = await code_interpreter.codes.create_context(SupportedLanguage.GO)
    ...
    async def test_08_code_execution_interrupt(self):
        ...
        python_int_context = await code_interpreter.codes.create_context(SupportedLanguage.PYTHON)
        ...
        with pytest.raises(SandboxApiException):
            await code_interpreter.codes.interrupt(fake_id)
        logger.info("✓ Interrupting non-existent execution raises exception as expected")
