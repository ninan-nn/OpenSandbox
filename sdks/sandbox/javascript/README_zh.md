...
```bash
pnpm add @alibaba/opensandbox
```

### yarn

```bash
yarn add @alibaba/opensandbox
```
...
```ts
import { ConnectionConfig, Sandbox, SandboxException } from "@alibaba/opensandbox";
...
```ts
import { SandboxManager } from "@alibaba/opensandbox";
