...
def _build_create_workload_context(
    ...
    execd_token_factory: Callable[[], str],
    ...
    annotations: Dict[str, str] = {}
    execd_auth_token = None
    if request.secure_access:
        execd_auth_token = execd_token_factory()
        annotations[SANDBOX_EXECD_AUTH_TOKEN_METADATA_KEY] = execd_auth_token
