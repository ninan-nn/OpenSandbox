...
- **Resource & Runtime Configuration**: Specify CPU/memory/GPU resource limits, required `entrypoint`, environment variables, optional `secureAccess`, and opaque `extensions`
